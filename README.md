...
* .fdx import where scenes are added automatically to the Boneyard.  Scene naming convention is #: I/E LOCATION where I or E is BOLD.  For example, 13: E WOODS  Time of Day checkbox should mark automatically
* Ability to select a single scene and have a border appear around it showing that it is selected
